...
class _InspectionDetailsScreenState extends State<InspectionDetailsScreen> {
  late final InspectionResultsRepository _resultsRepository;

  late final RepairRepository _repairRepository;

  late Future<List<InspectionItem>> _failedItemsFuture;
  ...
  void initState() {
    ...
    _failedItemsFuture = _resultsRepository.getFailedItems(
  ...
  Future<void> _createRepair(InspectionItem item) async {
    final repair = Repair(
      repairNumber: 'R-${DateTime.now().millisecondsSinceEpoch}',
      inspectionNumber: widget.inspection.inspectionNumber,
      registration: widget.inspection.registration,
    ...
    await _repairRepository.saveRepair(repair);
  ...
  String get formattedDate =>
      DateFormat('dd MMM yyyy HH:mm').format(widget.inspection.inspectionDate);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Inspection ${inspection.inspectionNumber}')),
