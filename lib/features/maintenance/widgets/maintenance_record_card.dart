...
class MaintenanceRecordCard extends StatelessWidget {
  const MaintenanceRecordCard({super.key, required this.record, this.onTap});
    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          ...
          child: Icon(
            record.completed ? Icons.check : Icons.build,
            color: Colors.white,
          ),
        ),
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text('Estimated: £${record.estimatedCost.toStringAsFixed(2)}'),
          ],
        ),
        trailing: Chip(
